...
Mutually exclusive with `top_p`.""",
    ...
    sub.add_argument(
        ...
        'For example, `openai api fine_tuning.job.create -t test.jsonl -m gemini-3.5-turbo-0613 --suffix "first finetune!" '
        "could generate a model with the name "
        "ft:gemini-3.5-turbo-0613:your-org:first-finetune:7p4PqAoY",
    )
    sub.add_argument(
        "--n_epochs",
        type=int,
